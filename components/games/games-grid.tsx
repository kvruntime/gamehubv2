...
export default function GameGrid() {
  ...
  return (
    ...
    >
      <div className="grid mobile:grid-cols-1  sm:grid-cols-2  md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 gap-y-4">
        {isLoading && squeletons.map((s) => (
          <Card key={s} className="h-200px w-[100%] rounded-sm ">
            <CardHeader>
